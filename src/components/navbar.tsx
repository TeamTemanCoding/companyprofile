...
export default function Nav(){
    return(
        <div className=" bg-black/5 backdrop-blur-md flex flex-row w-screen fixed z-50 space justify-between items-center">
            ...
            <div className=" flex flex-row text-white border-2 p-2 font-bold px-7 border-purple-950 rounded-full border-solid gap-4">
                ...
                <div className=" bg-purple-600 w-20 h-10 rounded-3xl relative"></div>
            </div>
            <div>
